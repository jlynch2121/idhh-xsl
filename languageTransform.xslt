...
<xsl:stylesheet xmlns:default="http://www.openarchives.org/OAI/2.0/"
  ...
  <xsl:template name="normLang">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$lowercaseLang = 'nor' or
        $lowercaseLang = 'no'">
        <xsl:element name="dc:language">
      ...
      <xsl:when test="$lowercaseLang = 'yid' or
        $lowercaseLang = 'yi'">
        <xsl:element name="dc:language">
      ...
      <xsl:when test="$lowercaseLang = 'dut' or
        $lowercaseLang = 'nld' or
        $lowercaseLang = 'nl'">
        <xsl:element name="dc:language">
      ...
      <xsl:when test="$lowercaseLang = 'heb' or
        $lowercaseLang = 'he'">
        <xsl:element name="dc:language">
